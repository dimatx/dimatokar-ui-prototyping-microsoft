...
function BicepIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12.4 7.8c1.2-1.5 3.2-2.8 5-2.2 2.1.7 2.6 3.3 1.6 5.2-.7 1.3-2 2.4-3.2 3.2" />
      <path d="M8.5 11c-1.5 1-2.8 2.5-2.5 4.3.3 2 2.5 3 4.4 2.5 1.4-.4 2.6-1.4 3.4-2.6" />
      <path d="M15.8 14c.6 1.5.6 3.3-.5 4.5-1.3 1.5-3.6 1.5-5 .3-1-.8-1.6-2.1-1.8-3.4" />
      <path d="M9 7.5c-.8-1.3-2.2-2.3-3.8-2-1.8.4-2.7 2.3-2.2 4 .4 1.3 1.4 2.3 2.6 3" />
