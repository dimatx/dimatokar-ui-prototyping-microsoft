...
export const ADU_UPDATES: AduUpdate[] = [
  {
    ...
    files: [
      { name: 'zava-turbine-fw-3.0.5.swu', sizeMb: 14.2, sha256: 'a3f8c2d91e4b7a05f6c3e8d2b14f9a7c2e5b8d3f1a6c9e2b5d8f1a4c7e0b3d6' },
      { name: 'post-install.sh', sizeMb: 0.02, sha256: 'c7e0b3d6a3f8c2d91e4b7a05f6c3e8d2b14f9a7c2e5b8d3f1a6c9e2b5d8f1a4' },
    ],
    installedCriteria: '3.0.5',
  },
  {
    provider: 'zava-energy',
    name: 'turbine-controller-fw',
    ...
    handler: 'microsoft/swupdate:2',
    files: [
      { name: 'zava-turbine-fw-3.1.0.swu', sizeMb: 18.7, sha256: 'b7d4e1f2a8c3b9e0d5f1a2c8d4e9b3f0a7c1e6b2d8f3a5c0e4b7d2f9a1c6e3b0' },
  ...
  },
  {
    ...
    name: 'turbine-controller-fw',
    version: '3.2.1',
    displayName: 'Emergency Auto Shut-off + Security Hardening',
    description: 'Critical safety update. Adds automated grid fault detection with sub-100ms safe shut-down sequencing. Patches CVE-2014-0160 (OpenSSL Heartbleed) and CVE-2024-7723. Required for NERC CIP compliance by 2026-06-01.',
    compatibility: [{ manufacturer: 'zava-energy', model: 'turbine-controller-v2' }],
    isDeployable: true,
    importedAt: '2026-02-18T14:00:00Z',
    handler: 'microsoft/swupdate:2',
    files: [
      { name: 'zava-turbine-fw-3.2.1.swu', sizeMb: 19.1, sha256: 'c9a2f5e1b8d4a0f7c3e9b5d1f8a4c0e6b2d8f4a0c6e2b9d5f1a7c3e0b6d2f8a4' },
